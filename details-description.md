...
- при обвале ЦОД-1: ЦОД-2 продолжит выдавать информацию из своих реплик, но не будет обрабатывать информацию на запись, только складывать в outbox события, которые отправит в кафку, как только восстановится кластер
**плюсы**
