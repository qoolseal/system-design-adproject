...
- **Kafka** кластер развёрнут на каждом ЦОД. Продюсеры и консюмеры региона работают только со своим локальным кластером
	- **Kafka в Москве** считается основным источником данных.
	- **Kafka в Новосибирске** — реплика для локального чтения и fallback при отказе.
	- Синхронизация через MirrorMaker (асинхронная репликация из топиков кластера в МСК в НСК кластер, в случае сбоя в главном кластере - в НСК будет доступно чтение из топиков, запись недоступна)
